...
import { PhilosophyWriter } from 'src/sections/components/forms/philosophy-writer';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.philosophyWriter)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                    variant="h5">{t(tokens.headings.philosophyWriter)}</Typography>
                </div>
