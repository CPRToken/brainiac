...
import { EssayWriter } from 'src/sections/components/forms/essay-writer';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.essayWriter)} />
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                    variant="h5">{t(tokens.headings.essayWriter)}</Typography>
                </div>
