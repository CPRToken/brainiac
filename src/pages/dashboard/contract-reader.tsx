...
import { DocReader } from 'src/sections/components/forms/contract-reader';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.contractReader)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                    variant="h5">{t(tokens.headings.contractReader)}</Typography>
                </div>
