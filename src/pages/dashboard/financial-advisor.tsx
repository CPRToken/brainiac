...
import { FinancialAdvisor } from 'src/sections/components/forms/financial-advisor';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.financialAdvisor)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                      variant="h5">{t(tokens.headings.financialAdvisor)}</Typography>
                </div>
