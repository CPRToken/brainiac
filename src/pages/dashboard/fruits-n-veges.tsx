...
import { FruitsNVeges } from 'src/sections/components/forms/fruits-n-veges';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.fruitsNVeges)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                      variant="h5">{t(tokens.headings.fruitsNVeges)}</Typography>
                </div>
