...
import { GovernmentPositions } from 'src/sections/components/forms/government-positions';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.biblicalFigures)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                    variant="h5">{t(tokens.headings.govPositions)}</Typography>
                </div>
