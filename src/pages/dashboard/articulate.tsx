...
import { Articulate } from 'src/sections/components/forms/articulate';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.Articulate)} />
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                    variant="h5">{t(tokens.headings.Articulate)}</Typography>
                </div>
