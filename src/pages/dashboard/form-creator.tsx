...
import { FormCreator } from 'src/sections/components/forms/form-creator';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.formCreator)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                      variant="h5">{t(tokens.headings.formCreator)}</Typography>
                </div>
