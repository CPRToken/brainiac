...
import { CodeConverter } from 'src/sections/components/forms/code-converter';
...
const Page: NextPage = () => {
  ...
  return (
    <>
      <Seo title={t(tokens.headings.codeConverter)} />
      <Box
        component="main"
        sx={{
          flexGrow: 1,
          ...
          >
            <Grid xs={12}>
              ...
              >
                <div>
                  <Typography
                      variant="h5">{t(tokens.headings.codeConverter)}</Typography>
                </div>
